...
module.exports = async (client, message) => {
  ...
  message.reply(`As of April 2022, Discord will be removing bot access to reading messages, meaning \`m-\` prefixed commands will no longer work. Please begin using the equivalent command \`/${cmd.help.name}\``);
